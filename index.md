...
* **Ukubona:** Update the onboarding instructions to include creating a GitHub account and send the updated instructions link to Gabriel (via WhatsApp).
* **Gabriel:** Create a GitHub account and share the username with Ukubona (via WhatsApp).
* **Ukubona:** Invite Gabriel to the project workspace on GitHub once the username is received.
